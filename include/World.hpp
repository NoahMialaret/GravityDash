...
private:
    IRect playableRegion;     // The playable region of the game
    // sf::RectangleShape renderRect;  // The playable region represented as a drawable object
